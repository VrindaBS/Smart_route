# Smart Route –  AI-Based Approach for Congestion Control

Smart Route is an AI-powered system that uses computer vision to detect traffic congestion using CCTV feeds. The system helps optimize urban mobility by classifying congestion levels and suggesting alternative routes dynamically.

## Features
- video frame analysis from live CCTV feeds
